    ...
    public partial class StockDetails : Form
    {
        ...
        private void StockDetails_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                   sql = " select  product_id as 'Item Code' , product_name as 'Item Name' , product_quantity as 'Quantity',  " +
                ...
                {
                    sql =  " select  product_id as 'كود المنتج' , product_name as 'اسم المنتج' , product_quantity as 'الكمية',  " +
                             " cost_price as 'سعر التكلفة' , retail_price as 'سعر البيع' ,   category as 'الصنف' , supplier as 'المورد'   " +
                             " from purchase order by product_quantity ";
                }
