...
{ 
    public partial class Stock_List : Form
    {
            ...
            try
            {
                ...
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    }else
                    {
                        details =
                        "====================================" +
                        "\n الرقم التعريفي: " + dataReader["product_id"] +
                        "\n الاسم: " + dataReader["product_name"].ToString() +
                        "\n سعر الشراء: " + dataReader["cost_price"].ToString() +
                        "\n كمية المخزون: " + dataReader["product_quantity"].ToString() +
                        "\n سعر التجزئة: " + dataReader["retail_price"].ToString() +
                        "\n خصم: " + dataReader["discount"].ToString() + "%" +
                        "\n الصنف: " + dataReader["category"].ToString() +
                        "\n المورد: " + dataReader["supplier"].ToString() +
                        "\n الفرع: " + dataReader["Shopid"].ToString() +
                        "\n الضريبة: " + taxapply +
                        "\n المطبخ  : " + KitchenDisplay +
                        "\n ====================================";
                    }
                    b.Name =  details;
                    ...
                    {
                        b.Text += "\n السعر: " + dataReader["cost_price"];
                        b.Text += "\n المخزون: " + dataReader["product_quantity"];
                        b.Text += "\n سعر  تجزئة: " + dataReader["retail_price"];
                        b.Text += "\n خصم: " + dataReader["discount"] + "% Tax: " + taxapply;
                    }
        ...
        {
            double height = int.Parse(Screen.PrimaryScreen.Bounds.Width.ToString()) * .8;
            flowLayoutPanelUserList.Width = (int) height;
