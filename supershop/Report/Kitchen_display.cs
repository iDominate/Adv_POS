        ...
        public void ItemList_with_images()
        {
            ...
            try
            {
                ...
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    {
                        b.Text += " ========================= ";
                        b.Text += "\n 'طلبية # " + dataReader["ReceiptNo"];
                        b.Text += "\n Staff: " + dataReader["emp_id"];
                        b.Text += "\n التاريخ: " + dataReader["Date"];
                        b.Text += "\n ========================= ";
                        b.Text += "\n " + dataReader["ItemName"].ToString();
                        b.Text += "\n الكمية: " + dataReader["Qty"];
                        // b.Text += "\n Total: " + dataReader["Total"];
                        b.Text += "\n ملاحظة: " + dataReader["Note"];
                    }
                    
                     

                    b.Font = new System.Drawing.Font("Cairo", 10, System.Drawing.FontStyle.Bold);
