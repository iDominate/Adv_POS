    ...
    public partial class Manage_user : Form
    {
        ...
        public void list_images()
        {
            ...
            { 
                ...
                string sqldb = "DELETE FROM usermgt where imagename = '-';";
                DataAccess.ExecuteSQL(sqldb);
                ...
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    //Button click event
                    Button b = new Button();
                    b.Font = new System.Drawing.Font("Cairo", 8, System.Drawing.FontStyle.Regular);
                    ...
                    /*          var nameImage = img_directory + dataReader["imagename"];
                    ...
                    {
                        b.Text += "\n الرقم التعريفي: " + dataReader["Username"];
                        b.Text += "\n الاسم: " + dataReader["Name"].ToString();
                        b.Text += "\n الهاتف: " + dataReader["Contact"].ToString();
                        b.Text += "\n الوظيفة: " + dataReader["position"];
                        b.Text += "\n " + dataReader["Email"];
                        b.Text += "\n " + dataReader["Shopid"];
                    }
        ...
        private void txtsearchUser_TextChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string sqldb = "DELETE  FROM usermgt where imagename = NULL";
                DataAccess.ExecuteSQL(sqldb);
                ...
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    if (dataReader["imagename"].ToString() == "-")
                    {
                        il.Images.Add(Image.FromFile(img_directory + "5.jpg"));
                    }
                    else
                    {
                        il.Images.Add(Image.FromFile(img_directory + dataReader["imagename"]));
        ...
        private void flowLayoutPanelUserList_Paint(object sender, PaintEventArgs e)
        {
