...
namespace supershop.User_mgt
{
    public partial class UserProfile : Form
    {
        ...
        public void loadData()
        {
            ...
            /*Convert.ToDateTime(dt1.Rows[0].ItemArray[6].ToString())*/
            dtDOB.Value = 
                Thread.CurrentThread.CurrentCulture.Parent.Name == "en"
                ? Convert.ToDateTime(dt1.Rows[0].ItemArray[6].ToString())
                :
                Convert.ToDateTime(dt1.Rows[0].ItemArray[6].ToString(), System.Globalization.CultureInfo.CreateSpecificCulture("en"))
                ;
