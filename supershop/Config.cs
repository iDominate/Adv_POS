...
namespace supershop
{
    ...
    {        
        ...
        {
            string sqlterminallist;
            if(Thread.CurrentThread.CurrentCulture.Parent.Name == "en")
            {
                sqlterminallist = "select Shopid as 'ID', Branchname	 ,Location ,Phone ,  " +
                                     " VAT as 'TAX %' ,Dis as 'Discount %'    from tbl_terminallocation";
            }else
            {
              sqlterminallist =  "select Shopid as 'الرقم التعريفي', Branchname as 'اسم الفرع'	 ,Location as 'الموقع' ,Phone as 'الهاتف',  " +
                                     " VAT as 'ضريبة %' ,Dis as 'خصم %'    from tbl_terminallocation";
            }
        ...
        private void Config_Load(object sender, EventArgs e)
        {
            ...
            foreach (Control item in dtgrdViewTerminallist.Controls)
            {
            ...
            foreach (Control item in tabterminal.Controls)
            {
                item.Font = new System.Drawing.Font("Cairo", 10, System.Drawing.FontStyle.Bold);
            }
            try
        ...
        private void lblShopID_Click(object sender, EventArgs e)
        {
