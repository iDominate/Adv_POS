...
namespace supershop.Expenses
{
    public partial class ExpensesList : Form
    {
        ...
        public void Expensebind()
        {
            ...
            {
               sql = " select  ID, Date , ReferenceNo as 'Refer No' , Category ,	Amount , Note ,	Createdby as 'Posted by', Attachment , fileextension from tbl_expense ";
            }else
            {
                sql =  " select  ID as 'الرقم التعريفي', Date as 'التاريخ', ReferenceNo as 'رقم' , Category as 'الصنف',	Amount as 'المبلغ', Note as 'ملاحظات',	Createdby as 'نشر من قبل', Attachment as 'متعلقات', fileextension as 'امتداد الملف' from tbl_expense ";
            }
