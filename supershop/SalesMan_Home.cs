...
namespace supershop
{
    public partial class SalesMan_Home : Form
    {
        public SalesMan_Home()
        {
            ...
            Userbtn.Text = UserInfo.UserName; 
        ...
        {
            ((Button)sender).BackColor = Color.FromArgb(103, 103, 103);
        }

        private void helpToolStripMenuItem_MouseEnter(object sender, EventArgs e)
        {
            ((ToolStripMenuItem)sender).BackColor = Color.FromArgb(52, 116, 208);
        }

        private void helpToolStripMenuItem_MouseLeave(object sender, EventArgs e)
        {
            ((ToolStripMenuItem)sender).BackColor = Color.FromArgb(103, 103, 103);
        }
    }
}
